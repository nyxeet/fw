...
const STATICS = {
  //@@viewOn:statics
  displayName: Config.TAG + "ParticipantCreateForm",
      ...
      >
        <UU5.Forms.ContextForm onSave={handleSave} onCancel={handleCancel}>
          <UU5.Bricks.Row>
            ...
            <UU5.Bricks.Column colWidth="m-6">
              <UU5.Forms.Text label={inputLsi.surname} name="surname" inputAttrs={{ maxLength: 255 }} />
            </UU5.Bricks.Column>
          </UU5.Bricks.Row>

          <UU5.Bricks.Row>
            <UU5.Bricks.Column colWidth="m-6">
              <UU5.Forms.Text label={inputLsi.passportId} name="passportId" inputAttrs={{ maxLength: 255 }} />
            </UU5.Bricks.Column>
            <UU5.Bricks.Column colWidth="m-6">
              <UU5.Forms.Text label={inputLsi.internationalId} name="internationalId" inputAttrs={{ maxLength: 255 }} />
            </UU5.Bricks.Column>
          </UU5.Bricks.Row>
          <UU5.Bricks.Row>
            <UU5.Bricks.Column colWidth="m-6">
              <UU5.Forms.Text label={inputLsi.insurance} name="insurance" inputAttrs={{ maxLength: 255 }} />
            </UU5.Bricks.Column>
            <UU5.Bricks.Column colWidth="m-6">
