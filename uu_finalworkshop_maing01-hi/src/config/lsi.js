const Lsi = {
  appName: {
    cs: "Aplikace uuFinalworkshop",
    en: "Application uuFinalworkshop",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci uuFinalworkshop",
      en: "About application uuFinalworkshop",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuFinalworkshop.",
      en: "You can buy your own uuFinalworkshop.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuFinalworkshop.",
      en: "You don't have rights to initialize this uuFinalworkshop.",
    },
  },
