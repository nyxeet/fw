...
const Errors = require("../api/errors/finalworkshop-main-error.js");
...
const logger = LoggerFactory.get("FinalworkshopMainAbl");
...
class FinalworkshopMainAbl {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["finalworkshopMain"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuFinalworkshop",
        typeCode: "uu-finalworkshop-maing01",
        location: location,
...
module.exports = new FinalworkshopMainAbl();
